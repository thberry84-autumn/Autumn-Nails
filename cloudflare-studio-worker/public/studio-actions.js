(() => {
  ...
  function addTreatmentUI(){
    ...
    button.onclick=async()=>{
      ...
      if(!studioClients.length){alert('No clients are available yet. Add the client first.');return;}
  ...
  async function init(){addBookingUI();addTreatmentUI();await refreshClients()}
