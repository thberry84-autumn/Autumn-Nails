(() => {
  ...
  const installEditor=()=>{
    ...
    style.textContent=`
      ...
      .uk-date-picker-wrap{position:relative;width:100%;min-height:44px;}
      .uk-date-picker-wrap .uk-date-display{width:100%;min-height:44px;box-sizing:border-box;display:flex;align-items:center;padding:13px 14px;border:1px solid var(--line);border-radius:14px;background:rgba(255,255,255,.72);color:var(--espresso);}
