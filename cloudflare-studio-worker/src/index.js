...
export default {
  async fetch(request, env) {
    ...
    const styles = '<link rel="stylesheet" href="/studio-customer-theme.css?v=20260904">';
    const scripts = '<script src="/studio-actions.js?v=20260904"></script><script src="/studio-calendar.js?v=20260904"></script><script src="/studio-calendar-layout.js?v=20260904c"></script><script src="/studio-booking-fixes.js?v=20260904c"></script>';
