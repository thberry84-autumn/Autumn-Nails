...
export default {
  async fetch(request, env) {
    ...
    const scripts = '<script src="/studio-actions.js?v=20260904"></script><script src="/studio-calendar.js?v=20260904"></script><script src="/studio-calendar-layout.js?v=20260904b"></script><script src="/studio-booking-fixes.js?v=20260904"></script>';
